...
- [x] 1. Dynamic 4-Dimension CIMD selector in header with equal weight auto-budgeting (1/2/3/4 selection = 100%, 50%, 33.3%, 25%) <!-- id: 77, priority: high -->
- [x] 2. Default light DA heatmap base layer with dynamic shading, spectrum legend, toggle, and minimizable legend card <!-- id: 78, priority: high -->
- [x] 3. 400m catchment buffer update: rich purple solid line, 1pt stroke width, hollow fill <!-- id: 79, priority: high -->
- [x] 4. Full-page Bus Stop Directory Modal with Grade filter tabs, sortable columns (Stop ID, Neighbourhood, Population 400m, Blended Score, Percentile), and expandable DA breakdown sub-rows <!-- id: 80, priority: critical -->
- [x] 5. Add "Bus Stop Directory" link to all navigation menus (`GlobalNavMenu`, `StaggeredMenu`, header/sidebars) <!-- id: 81, priority: high -->
- [x] 6. Clean up: Remove obsolete inline directory sidebar from `BusStopAnalysis.tsx` for cleaner map focus <!-- id: 82, priority: medium -->
