        ...
        <div className="w-full max-w-3xl px-6 flex flex-col gap-24 mt-8">
          ...
          <section id="section-6" className={getSectionClass('section-6')}>
            <div className="space-y-4">
              ...
              <p className="text-slate-600 text-base leading-relaxed">
                The Transit Monopoly pillar calculates neighbourhood dependence on a single bus route. If a neighbourhood lacks alternative bus routes or LRT stations within walking distance, the active route operates as a transit monopoly. Decision makers must consider this reliance when adjusting service.
              </p>
            ...
            {route2Data && route3Data && daGeoJson && (
              <>
                ...
                />
                <p className="text-slate-500 text-xs md:text-sm italic text-center mt-1">
                  The maps shows the routes around <strong className="text-blue-600">Route 002</strong> and <strong className="text-amber-600">Route 003</strong> and the score in this pillar is related to what other alternative transit routes are available to the riders of those routes should service be changed.
                </p>
              </>
            )}
            ...
            <div className="space-y-4">
              ...
              <ul className="text-base text-slate-600 leading-relaxed mt-2 space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span className="flex-1">
                    <strong className="text-blue-600">Route 002</strong> receives a score of 68.1 or a B grade as it has high scores from the vulnerability, monopoly, and destination opportunity pillars. This makes it a high scoring route and highly important for transit equity.
                  </span>
                </li>
                <li className="flex items-start gap-2">
            ...
            <div className="space-y-4">
              <div className="flex flex-col gap-6 pl-2 py-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed border-l-2 border-slate-200 pl-4 ml-3.5 italic">
                    <strong className="text-amber-600">Route 003</strong> is a High Swing Route because its score rises under an Off-Peak Service focus but drops when we prioritize Transit Monopoly or Transit Vulnerability. Specifically, <strong className="text-amber-600">Route 003</strong> maintains a decent evening and weekend schedule (scoring 38.0 in Off-Peak), which pulls its grade up when temporal service is prioritized. However, because it runs through central neighbourhoods with abundant overlapping transit routes and higher average incomes, its Monopoly score is an absolute 0.0 and its Vulnerability score is a low 17.5. When pillar weights shift to favor demographic need or route dependency, <strong className="text-amber-600">Route 003</strong>'s score collapses, making its relative funding priority highly sensitive to the chosen weighting model.
                  </p>
                </div>
